...
class TestCreatorProfileForm(unittest.TestCase):
    ...
    def test_clean_contact_number_non_numeric(self):
        form_data = {
            ...
            "organization_email": "org@example.com",
            "organization_social_media": "http://example.org",
            "contact_number": "abc1234567",  # Non-numeric characters
        }
        form = CreatorProfileForm(data=form_data)
    ...
    def test_clean_contact_number_empty(self):
        # Depending on requirements, an empty contact number might be allowed or not.
        # If it's optional, this should pass. If it's required, you'd expect a failure.
        # For this example, let's assume it's optional.
        form_data = {
            "organization_name": "My Org",
            "organization_email": "org@example.com",
            "organization_social_media": "http://example.org",
